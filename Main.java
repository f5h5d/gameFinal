...
public class Main extends JPanel implements KeyListener, Runnable {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (gameState == 0) {
            ...
            g2d.setPaint(Color.BLACK);
            g2d.drawRect(p2PosX, p2PosY, p2CurrentMovement.getWidth(),
            p2CurrentMovement.getHeight());
        ...
        if (player.equals("p1")) {
            ...
            if (frameController % p2MoveLength[forward] == 0) {
                if (!checkForCollisions("p2", "walk").equals("Out of bounds")) {
                    ...
                    p2PosX = windowWidth - (p2CurrentMovement.getWidth() == 199 ? 70 : p2CurrentMovement.getWidth());
                }
    ...
    public static String checkForCollisions(String playerToCheck, String move) {
        ...
        int p2Left = p2PosX;
        int p2Right = p2PosX + (p2CurrentMovement.getWidth() == 199 ? 70 : p2CurrentMovement.getWidth());
        ...
        if (playerToCheck.equals("p1")) {
            ...
            if (move.equals("high")) {
                ...
                if (p2Right > 800) {
                    // System.out.println()
                    System.out.println(p2CurrentMovement.getWidth());
                    return "Out of bounds";
                }
